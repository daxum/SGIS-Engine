...
public:
	 ...
	 * Must be freed using freeTextModel later!
	...
	/**
	 * Frees any resources used by the model.
	 * @param model A model previously generated by createTextModel.
	 */
	void freeTextModel(const Model& model);
